...
Developing expertise demands substantial amounts of high-quality training \cite{ericsson_role_1993, ericsson_expert_1994, ericsson_development_2003,}. Unlike training novices to reach acceptable levels on a task, the main challenge for skilled performers is finding ways to improve beyond current levels of performance\cite{}. One route to achieve this goal is to perfect an already selected strategy. This is a slow improvement process that operates through honing the components underlying the automated solution. A second route is to find new and superior ways to solve the task, which can sometimes lead to greater improvement leaps than simply repeating what is already automatized. Finding such creative and innovative solutions is a hallmark of expertise development; however, we know little about which training strategies are most effective at developing these strategies. If superior methods to those currently used in standard practice exist, they could prove invaluable for training both present and future generations of learners.
